<template>
  <div>
    <div class="q-pa-md q-gutter-sm bg-grey-3 text-weight-medium text-black">
      <q-btn
        ...
        to="/tiendas"
      ></q-btn>
      <h5 class="q-my-none q-mx-lg">Editar Tienda</h5>
  ...
  <div class="">
    <q-card class="q-pa-lg q-ma-lg absolute-center row">
      ...
      <q-form @submit="updateTienda()" class="q-gutter-md col-12">
        <q-input
          outlined
          v-model.trim="nombre"
          max="100"
...
export default {
  ...
  methods: {
    ...
    async updateTienda() {
      ...
      try {
        await api.post(
          `http://localhost:8080/api/tiendas/editar/${tienda}`,
          nuevosDatos,
          {
            params: {
              api_key: "7aa8e437-4257-468a-8bd5-aafb9396ab53",
        ...
        console.log("Tienda editado exitosamente");
