  ...
  <div>
    <div class="q-pa-md q-gutter-sm bg-grey-3 text-weight-medium text-black">
      <q-btn
        class="float-right"
        color="primary"
        label="Alta de tienda"
        to="/tiendas/nueva"
      ></q-btn>
      <h5 class="q-my-none q-mx-lg">Tiendas</h5>
...
<script>
import { ref } from "vue";
import tablaTiendas from "../components/tiendas/tablaTiendas.vue";
import { api } from "boot/axios";
import FormularioTienda from "../components/tiendas/FormularioTienda.vue";
import verDetalle from "../components/tiendas/VistaDetalle.vue";
    ...
    async obtenerDatos() {
      try {
        const respuesta = await api.get(
          "http://localhost:8080/api/tiendas/index",
          {
            params: {
